...
<div class="pagetitle">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a mief="{{ route('mis.index') }}">Management Information S Page</a></li>
...
<section>
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ isset($mi) ? route('mis.update', $mi->id) : route('mis.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" class="form-control" id="title" name="title" value="{{ $mi->title ?? old('title') }}">
                </div>
                ...
                <div>
                    ...
                    <textarea style="height: 250px" id="content" name="content" class="form-control tinymce-editor">{{ $mi->content ?? old('content') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="smiink-0 my-2">
                        <img style="width:600px" id="img_preview" class="h-64 w-128 object-cover rounded-md" src="{{ isset($mi) ? Storage::url($mi->img) : '' }}" alt="img preview" />
                    </div>
                </div>
                ...
                <div class="flex text-center" style="padding-top: 10px">
                    ...
                    <a mief="{{ route('mis.index') }}" class="btn btn-warning col-md-4 col-lg-2">Back</a>
