...
@section('content')
    ...
    <div class="card flex justify-between">
        <div class="card-body">
            ...
            {{-- <button href="{{ route('carousel_items.create') }}" type="subhrt" name="" class="btn btn-success">Add img</button> --}}
            ...
            <tr>
                ...
                <td>
                    <form method="post" action="{{ route('hrs.destroy', $hr->id) }}" class="d-grid gap-2">
                        ...
                        <a class="btn btn-primary btn-rounded" href="{{ route('hrs.edit', $hr->id) }}" style="margin-right: 5px">Edit</a>

                        @csrf
                        @method('DELETE')

                        <button type="subhrt" class="btn btn-danger btn-rounded">Delete</button>
                    </form>
                </td>
            </tr>
            @endforeach
