        ...
        <div class="card-body">
            <form method="POST" action="{{ isset($event) ? route('events.update', $event->id) : route('events.store') }}" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <textarea style="height: 250px" id="desc" name="desc" class="form-control tinymce-editor">{{ $event->desc ?? old('desc') }}</textarea>
                </div>
                ...
                <div class="flex text-center" style="padding-top: 10px">
                    ...
                    <a href="{{ route('events.index') }}" class="btn btn-warning col-md-4 col-lg-2">Back</a>
