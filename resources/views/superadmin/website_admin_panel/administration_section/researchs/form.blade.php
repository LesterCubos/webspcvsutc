...
<div class="pagetitle">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('researchs.index') }}">Research and Extension Page</a></li>
...
<section>
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ isset($research) ? route('researchs.update', $research->id) : route('researchs.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" class="form-control" id="title" name="title" value="{{ $research->title ?? old('title') }}">
                </div>
                ...
                <div>
                    ...
                    <textarea style="height: 250px" id="content" name="content" class="form-control tinymce-editor">{{ $research->content ?? old('content') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="shrink-0 my-2">
                        <img style="width:600px" id="img_preview" class="h-64 w-128 object-cover rounded-md" src="{{ isset($research) ? Storage::url($research->img) : '' }}" alt="img preview" />
                    </div>
                </div>
                ...
                <div class="flex text-center" style="padding-top: 10px">
                    ...
                    <a href="{{ route('researchs.index') }}" class="btn btn-warning col-md-4 col-lg-2">Back</a>
