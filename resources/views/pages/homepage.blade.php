                ...
                @if ($loop->iteration % 2 == 1 )
                    ...
                    <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                        ...
                        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false">
                            <image href="{{ asset('storage/' . $carousel_item->featured_image) }}" width="100%" height="100%" preserveAspectRatio="xMidYMid slice" />
                        </svg>
                        {{-- <div class="img"><img class="d-block img-fluid" src="{{ asset('storage/' . $carousel_item->featured_image) }}" alt="First slide"></div> --}}
                        <div class="container">
