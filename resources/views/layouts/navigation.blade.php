        ...
        <div class="flex justify-between h-16">
            <div class="flex"> --}}
                ...
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <!-- add this -->
                    <x-nav-link :href="route('carousel_items.index')" :active="request()->routeIs('carousel_items.index')">
                        {{'Carousel Items' }}
                    </x-nav-link>
                </div> --}}
            {{-- </div> --}}
...
{{--
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- add this -->
            <x-responsive-nav-link :href="route('carousel_items.index')" :active="request()->routeIs('carousel_items.index')">
                {{ 'Carousel Items' }}
            </x-responsive-nav-link>
        </div>
